...
More details on this [paper](https://arxiv.org/abs/2007.11111).
Also, you can find source code and more info on the [FGLT repository on Github](https://github.com/fcdimitr/fglt).
